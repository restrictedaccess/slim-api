...
class RemoteReadyCandidatesResource extends CandidatesResource
{
    /**
     * @param $request
     * @return array
    ...
    public function getCandidates($request){
        ...
        //SET FILTER
        $filter = "candidate_progress:remote_ready";
        //ADD SORT
        ...
        $query -> createFilterQuery("remote_ready_candidate_progress_filter" ) -> setQuery( $filter );
