...
class PrescreenedCandidatesResource extends CandidatesResource
{
    /**
     * @param $request
     * @return array
    ...
    public function getCandidates($request){
        ...
        //SET FILTER
        $filter = "candidate_progress:prescreened";

        $controllerName = "prescreened";
        ...
        $query -> createFilterQuery("prescreened_candidate_progress_filter" ) -> setQuery( $filter );
